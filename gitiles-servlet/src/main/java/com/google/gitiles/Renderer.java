...
public abstract class Renderer {
  ...
  /**
   * Start a streaming response with header and footer rendered by Soy.
   * <p>
   ...
   * @param templateName fully-qualified template name.
   * @param soyData Soy template data.
   ...
   * @throws IOException an error occurred writing the header.
   */
