...
public class SearchServlet extends BaseServlet {
  ...
  public SearchServlet(GitilesAccess.Factory accessFactory, Renderer renderer, Config cfg) {
  ...
  protected void doGetHtml(HttpServletRequest req, HttpServletResponse res)
    ...
    String branches = req.getParameter("branches");

    Restriction restriction = new Restriction(view.getRepositoryName(), branches);
    ...
    String repositoryUrl = getRepositoryUrl(req, view);
    data.put("repositoryUrl", repositoryUrl);
    data.put("searchResult", searchResult.toSoyData(repositoryUrl));
