...
public class MatchingFile {
  ...
  public MatchingLine[] getLines() {
    return lines;
  }

  public Map<String,Object> toSoyData(String revisionUrl) {
  ...
  public static List<Map<String,Object>> toSoyData(MatchingFile[] files, String revisionUrl) {
