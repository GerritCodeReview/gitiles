...
public interface UrlSigner {
   ...
   * @return validation structure if the signature is valid; {@code null} if it
   *         has expired or is invalid in any way.
   */
  ...
  public static class Signature {
     ...
     * @param expires milliseconds since the epoch when {@code signature}
     *        expires; {@code 0} indicates {@code signature} expires "quickly".
     */
    ...
    /**
     * @return milliseconds since the epoch when this signature will expire and
     *         no longer be accepted. If 0 the signature is assumed to expire
  ...
  public static class ValidatedSignature {
    ...
    /**
     * @param expires milliseconds since the epoch when the source
     *        {@code signature} expires; {@code 0} indicates "now".
     */
