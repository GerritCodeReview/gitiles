...
public class CommentLinkInfo {
  ...
  private static void addHtml(List<Map<String, String>> parts, String html) {
    parts.add(ImmutableMap.of("html", UnsafeSanitizedContentOrdainer.ordainAsSafe(html, SanitizedContent.ContentKind.HTML).toString()));
  }
