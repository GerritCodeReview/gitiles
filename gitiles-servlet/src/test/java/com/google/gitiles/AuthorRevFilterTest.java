 ...
 *
 * Unfortunately it's not easy to test the Filter using real {@link RevCommit}s because
 * {@link TestRepository} hard-codes its author as "J. Author". The next best thing is to test a
 * {@link PersonIdent}, those are easy to construct. {@link AuthorRevFilter#matchesPerson} method is
 */
public class AuthorRevFilterTest {
  ...
  @Test
  public void matchesEmailName() throws Exception {
    AuthorRevFilter filter = new AuthorRevFilter("eSt");
  ...
  @Test
  public void caseSensitiveEmailName() throws Exception {
    AuthorRevFilter filter = new AuthorRevFilter("eSt");
  ...
  @Test
  public void emailDomain() throws Exception {
