...
public class FileSearchTest extends ServletTest {
  ...
  /**
   * A revision that peels to something other than a commit addresses no path view: {@code
   * TreeSoyData} suppresses its log, grep and archive links under exactly the same condition
   * (TreeSoyData.java:165-166), and the listing route is a path view.
   */
  @Test
