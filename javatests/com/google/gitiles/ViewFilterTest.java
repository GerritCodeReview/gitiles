...
public class ViewFilterTest {
  ...
  public void noCommand() throws Exception {
    ...
    assertThrows(RequestFailureException.class, () -> getView("/repo/+"));
    assertThrows(RequestFailureException.class, () -> getView("/repo/+/"));
  }
  ...
  public void describe() throws Exception {
    ...
    assertThrows(RequestFailureException.class, () -> getView("/repo/+describe"));
    assertThrows(RequestFailureException.class, () -> getView("/repo/+describe/"));
  ...
  public void showBranches() throws Exception {
    ...
    assertThrows(RequestFailureException.class, () -> getView("/repo/+show/stable..master"));
  }
  ...
  public void path() throws Exception {
    ...
    assertThrows(RequestFailureException.class, () -> getView("/repo/+show/stable..master/foo"));
  }
  ...
  public void doc() throws Exception {
    ...
    assertThrows(RequestFailureException.class, () -> getView("/repo/+doc/stable..master/foo"));
  }
  ...
  public void multipleSlashes() throws Exception {
    ...
    assertThat(getView("//repo").getType()).isEqualTo(Type.REPOSITORY_INDEX);
    assertThat(getView("//repo//").getType()).isEqualTo(Type.REPOSITORY_INDEX);
    assertThrows(RequestFailureException.class, () -> getView("/repo/+//master"));
    assertThrows(RequestFailureException.class, () -> getView("/repo/+/refs//heads//master"));
    assertThrows(RequestFailureException.class, () -> getView("/repo/+//master//"));
    assertThrows(RequestFailureException.class, () -> getView("/repo/+//master/foo//bar"));
  }
  ...
  public void archive() throws Exception {
    ...
    assertThrows(RequestFailureException.class, () -> getView("/repo/+archive"));
    assertThrows(RequestFailureException.class, () -> getView("/repo/+archive/"));
    assertThrows(RequestFailureException.class, () -> getView("/repo/+archive/master..branch"));
    assertThrows(RequestFailureException.class, () -> getView("/repo/+archive/master.foo"));
    assertThrows(RequestFailureException.class, () -> getView("/repo/+archive/master.zip"));
    assertThrows(RequestFailureException.class, () -> getView("/repo/+archive/master/.tar.gz"));
    assertThrows(RequestFailureException.class, () -> getView("/repo/+archive/master/foo/.tar.gz"));
  ...
  public void blame() throws Exception {
    ...
    assertThrows(RequestFailureException.class, () -> getView("/repo/+blame"));
    assertThrows(RequestFailureException.class, () -> getView("/repo/+blame/"));
    assertThrows(RequestFailureException.class, () -> getView("/repo/+blame/master"));
    assertThrows(RequestFailureException.class, () -> getView("/repo/+blame/master..branch"));
