...
public class PathServletTest extends ServletTest {
  ...
  public void symlinkHtml() throws Exception {
    validateSymlink("foo", "bar", "foo");
  }

  @Test
  public void relativeSymlinkHtml() throws Exception {
    validateSymlink("foo/bar", "foo/baz", "./bar");
  }
  ...
  private void validateSymlink(String linkTarget, String linkName, String link) throws Exception {
    final RevBlob linkBlob = repo.blob(link);
    repo.branch("master")
        .commit()
    ...
    assertThat(getBlobData(data)).containsEntry("target", link);
