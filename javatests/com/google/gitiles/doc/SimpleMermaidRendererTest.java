...
public class SimpleMermaidRendererTest {
  ...
  public void testGraphDirectionsAndFallbacks() {
    ...
    defSvg.assertNoNodeOverlaps();
    defSvg.assertNoLabelNodeOverlaps();
    ...
    fallbackSvg.assertNoNodeOverlaps();
    fallbackSvg.assertNoLabelNodeOverlaps();
  ...
  public void testSubgraphToSubgraphAndSubgraphToNodeEdges() {
    ...
    svgTD.assertRootSvg();
    svgTD.assertNoNodeOverlaps();
    svgTD.assertNoLabelNodeOverlaps();
    svgTD.assertSubgraphsDoNotOverlap();
    ...
    // Subgraph-to-subgraph edge is rendered with arrow marker
    ...
    svgLR.assertRootSvg();
    svgLR.assertNoNodeOverlaps();
    svgLR.assertNoLabelNodeOverlaps();
    svgLR.assertSubgraphsDoNotOverlap();
    ...
    Optional<String> svgLRBlockedOpt = SimpleMermaidRenderer.renderToSvg(codeLRWithBlockedNode);
    assertThat(svgLRBlockedOpt.isPresent()).isTrue();
    SvgDoc svgLRBlocked = new SvgDoc(svgLRBlockedOpt.get());
    svgLRBlocked.assertRootSvg();
    svgLRBlocked.assertNoNodeOverlaps();
    svgLRBlocked.assertNoLabelNodeOverlaps();
    svgLRBlocked.assertSubgraphsDoNotOverlap();
  ...
  public void testHorizontalGraphWithCycleAndLongSpanEdge() {
    ...
    doc.assertRootSvg();
    doc.assertNoNodeOverlaps();
    doc.assertNoLabelNodeOverlaps();
  ...
  public void testNestedSubgraphWithLooseSourceCompaction() {
    ...
    doc.assertNoNodeOverlaps();
    doc.assertNoLabelNodeOverlaps();
    doc.assertSubgraphsDoNotOverlap();
  ...
  public void testRemainingEdgeCasesForFullCoverage() {
    ...
    doc1.assertRootSvg();
    doc1.assertNoNodeOverlaps();
    doc1.assertNoLabelNodeOverlaps();
    ...
    doc2.assertRootSvg();
    doc2.assertNoNodeOverlaps();
    doc2.assertNoLabelNodeOverlaps();
    ...
    doc3.assertRootSvg();
    doc3.assertNoNodeOverlaps();
    doc3.assertNoLabelNodeOverlaps();
    ...
    SvgDoc doc5 = new SvgDoc(svg5.get());
    doc5.assertRootSvg();
    doc5.assertNoNodeOverlaps();
    doc5.assertNoLabelNodeOverlaps();
  ...
  private static class SvgDoc {
    ...
    @Nullable Element findText(String text) {
      for (Element t : getElementsByTag("text")) {
        ...
        if (text.equals(full) || text.equals(t.getTextContent().trim())) {
          return t;
        }
      }
    ...
    static class Rect2D {
      ...
      Rect2D(double x, double y, double width, double height, String label) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
      ...
      boolean overlaps(Rect2D other, double tolerance) {
      ...
      boolean contains(Rect2D inner, double padding) {
    ...
    List<Rect2D> getNodeBoundingBoxes() {
    ...
    List<Rect2D> getEdgeLabelBadgeBoundingBoxes() {
      List<Rect2D> list = new ArrayList<>();
      for (Element r : getElementsByTag("rect")) {
    ...
    List<Rect2D> getSubgraphBoundingBoxes() {
      List<Rect2D> list = new ArrayList<>();
      for (Element r : getElementsByTag("rect")) {
        if ("4,4".equals(r.getAttribute("stroke-dasharray"))) {
          double x = Double.parseDouble(r.getAttribute("x"));
    ...
    void assertNoLabelNodeOverlaps() {
      List<Rect2D> nodes = getNodeBoundingBoxes();
    ...
    void assertSubgraphsDoNotOverlap() {
  ...
  public void testMultiNodeChainingWithAmpersand() {
    ...
    multiDoc.assertRootSvg();
    multiDoc.assertNoNodeOverlaps();
    multiDoc.assertNoLabelNodeOverlaps();
  ...
  public void testSubgraphEdgeWithDirectionOverrideAndDynamicLabelSpacing() {
    ...
    // 1. Geometric non-overlap checks
    doc.assertNoNodeOverlaps();
    doc.assertNoLabelNodeOverlaps();
    doc.assertSubgraphsDoNotOverlap();

    // 2. Subgraph container layout and node containment checks
    ...
    // 3. Subgraph connecting edge geometry
    ...
    // 4. Intra-subgraph horizontal edge paths
    List<Element> paths = doc.getEdgePaths();
