...
// EE10 (jakarta.servlet) override of the canonical EE8 (javax.servlet)
// javatests/com/google/gitiles/FakeHttpServletResponse.java. It keeps the same
// FQDN (package com.google.gitiles, same class name) so the forward-generated
// (javax -> jakarta) test sources resolve it without any import change. It is
// hand-written because the Servlet 4 -> Servlet 6 API drift cannot be bridged by
// a pure import rename: encodeUrl/encodeRedirectUrl/setStatus(int,String) were
// removed in Servlet 6, and sendRedirect(String,int,boolean) was added.
...
public class FakeHttpServletResponse implements HttpServletResponse {
  ...
  // Added in Servlet 6.1 (jakarta); has no javax.servlet counterpart.
  @Override
