...
public class GrepServletTest extends ServletTest {
  @Test
  public void grepJsonSearchesFileContents() throws Exception {
    repo.branch("master")
        .commit()
        .add("dir/a.txt", "alpha\nneedle here\n")
    ...
    GrepResult result = buildJson(GrepResult.class, "/repo/+grep/master", "q=needle");
  ...
  public void grepJsonCanSearchPathPrefix() throws Exception {
    ...
    GrepResult result = buildJson(GrepResult.class, "/repo/+grep/master/src", "q=needle");
  ...
  @Test
  public void grepJsonRequiresQuery() throws Exception {
