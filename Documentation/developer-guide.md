...
(http://mojo.codehaus.org/versions-maven-plugin/version-rules.html), which in
practice just means incrementing the last component (after the `-`) by one. Get
your change reviewed and submitted.
