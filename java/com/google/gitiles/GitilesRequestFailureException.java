...
public final class GitilesRequestFailureException extends RuntimeException {
  ...
  public enum FailureReason {
    ...
    AMBIGUOUS_OBJECT(SC_BAD_REQUEST, "The object specified by the URL is ambiguous and Gitiles cannot identify one object"),
     ...
     * tree).
     */
    INCORRECT_OBJECT_TYPE(SC_BAD_REQUEST, "The object specified by the URL is not suitable for the view"),
