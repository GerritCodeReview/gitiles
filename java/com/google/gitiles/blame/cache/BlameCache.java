...
public interface BlameCache {
  ...
  /**
   * Gets the blame of a path at a given commit, ignoring the specified commits.
   *
   * @return the blame of a path at a given commit.
   */
  List<Region> get(Repository repo, ObjectId commitId, String path, Set<ObjectId> ignoreIds)
      throws IOException;
