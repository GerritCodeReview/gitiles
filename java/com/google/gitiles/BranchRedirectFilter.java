...
public class BranchRedirectFilter extends AbstractHttpFilter {
   ...
   * @param isForAutomation request is by automation.
  ...
  protected Optional<String> getRedirectBranch(
      Repository repo, String sourceBranch, boolean isForAutomation) {
    return Optional.empty();
  }

  private Optional<String> rewriteRevision(Repository repo, Revision rev, boolean isForAutomation) {
    if (Revision.isNull(rev)) {
      return Optional.empty();
    }
    return getRedirectBranch(repo, rev.getName(), isForAutomation);
  }
  ...
  public void doFilter(HttpServletRequest req, HttpServletResponse res, FilterChain chain)
    ...
    boolean isForAutomation = isForAutomation(req);

    Optional<String> rewrittenRevision = rewriteRevision(repo, view.getRevision(), isForAutomation);
    Optional<String> rewrittenOldRevision =
        rewriteRevision(repo, view.getOldRevision(), isForAutomation);
