...
/** Shared utilities that are used across this package. */
final class SharedUtility {
  /**
   * Innocuous output when a image data uri fails escaping.
   * When escaper fails, we need to return something that is both clearly an image, but clearly
