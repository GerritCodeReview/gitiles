...
public class PlantumlFencedCodeBlockParserExtension implements ParserExtension {
  ...
  private static class PlantumlFencedCodeBlockParser extends FencedCodeBlockParser {
    public PlantumlFencedCodeBlockParser(char fenceChar, int fenceLength, int fenceIndent) {
      ...
      plantumlBlock.setFenceChar(fenceChar);
      plantumlBlock.setFenceLength(fenceLength);
      plantumlBlock.setFenceIndent(fenceIndent);
    }

    private final PlantumlFencedCodeBlock plantumlBlock = new PlantumlFencedCodeBlock();
...
//      return super.getBlock();
    ...
    public void closeBlock() {
      super.closeBlock();
      FencedCodeBlock fencedBlock = (FencedCodeBlock) super.getBlock();
//      plantumlBlock.setInfo(fencedBlock.getInfo());
      plantumlBlock.setLiteral(fencedBlock.getLiteral());
      plantumlBlock.setInfo(PLANTUML);
    }
  }
