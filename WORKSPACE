...
# TODO(davido): Switch to using official closure-templates:soy release when available
# https://crbug.com/gerrit/15581
# https://github.com/google/closure-templates/issues/577
